...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3600252384ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=users">`users`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=todo&table=notes">`todo`.`notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=harshal&table=data">`harshal`.`data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=askme&table=categories">`askme`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=askme&table=user">`askme`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbharshal&table=data">`dbharshal`.`data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=harshal&table=new">`harshal`.`new`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbharshal&table=new">`dbharshal`.`new`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbharshal&table=NEW">`dbharshal`.`NEW`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=askme&table=comment">`askme`.`comment`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="545a2a4f6f4b735f4b3b5d5a6e376424">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sparks_bank" targettable="">
